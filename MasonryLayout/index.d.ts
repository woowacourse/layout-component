...
export type MasonryLayoutProps<T extends ElementType> = PolymorphicComponentProps<T, _MasonryLayoutProps>;
type MasonryLayoutComponent = <T extends ElementType>(props: MasonryLayoutProps<T>) => ReactElement | null;
declare const MasonryLayout: MasonryLayoutComponent;
